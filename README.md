...
- Lightweight and easy-to-use deployment

---

## 🧠 Model Overview

The deployed model was developed as part of an end-to-end machine learning project focused on:

- Customer propensity prediction
- Telemarketing campaign optimization
- Cost/loss minimization strategy
